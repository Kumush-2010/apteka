    ...
    bot.on('message', async (msg) => {
        ...
        if (searchStates.get(chatId) === 'awaiting_query') {
            ...
            if (results.length === 0) {
                ...
                // Avval "Topilgan dorilar" deb yozamiz
                await bot.sendMessage(chatId, `Topilgan dorilar:\n`, {
                    parse_mode: 'HTML'
                });
...
Ombordagi soni: ${med.warehouse} dona
                    ...
                    if (med.image_path && med.image_path.startsWith('http')) {
            ...
            // Qayta tanlash uchun tugmalarni yuboramiz
